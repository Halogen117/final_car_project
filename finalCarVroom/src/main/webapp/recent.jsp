                        ...
                        <div class="col">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body d-flex justify-content-center align-items-center flex-column border-bottom-primary">
                                    ...
                                    <div class="icon-circle bg-success" style="font-size: 90px; width: 150px; height: 150px;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="white" class="bi bi-clock-history" viewBox="0 0 16 16">
                                    ...
                                    <!-- Add a line of bolded text below the icon -->
                                    <p class="font-weight-bolder mt-4" style="font-size: x-large;">Your recent activities will appear here</p>
                                    <p class="font-weight-bolder mt-1" style="font-size: small;">Looking for visited carparks? Come back here to find it easily again.</p>
                                </div>
                            </div>
