...
<head>
    ...
    <title>Carpark Near U - GuestHomePage</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="guestpage.jsp">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="guestpage.jsp">
