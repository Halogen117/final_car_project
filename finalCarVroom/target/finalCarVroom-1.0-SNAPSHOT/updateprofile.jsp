                            ...
                            <div class="container bg-white mt-3 mb-3">
                                <div class="row">
                                    <div class="col-md-3 border-right">
                                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="img/undraw_profile.svg"><span class="font-weight-bold mt-3">User Tan</span><span> </span></div>
                                    </div>
                                    <div class="col ">
                                        <div class="p-3 py-5">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12 mb-3"><label class="labels">Username</label><input type="text" class="form-control" placeholder="Update Username" value=""></div>
                                                <div class="col-md-12 mb-3"><label class="labels">Mobile Number</label><input type="text" class="form-control" placeholder="Update Mobile No." value=""></div>
                                               
                                                <div class="col-md-12 mb-3"><label class="labels">Email</label><input type="text" class="form-control" placeholder="Update Email" value=""></div>
